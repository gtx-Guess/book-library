...
export default function AddCurrentlyReadingPage() {
  ...
  const handleConfirmAdd = async (startedDate?: string) => {
    ...
    try {
      ...
      await api.addCurrentlyReadingBook({
      ...
      const errorMessage = err.response?.data?.error || 'Failed to add book to currently reading list';
  ...
  const handleConfirmManualCurrentlyReading = async (startedDate?: string) => {
    ...
    <div className="container">
      ...
      {manualBook && (
        <ConfirmCurrentlyReadingModal
          ...
          onConfirm={handleConfirmManualCurrentlyReading}
